...
//   return (
//     <>
//     <div className=" bg-slate-900 flex items-center justify-center p-4 h-1/4 realtive z-100">
...
//         <div className="text-center mb-8">
//           <h2 className="text-3xl font-bold text-yellow-50">Tech Team</h2>
//           <p className="text-gray-400 mt-2">Meet our Tech Experts</p>
//         </div>
...
//             >
//               {/* Hover Tooltip (Visible on Hover for Desktop and Long Press for Mobile) */}
...
//               {/* Member Display */}
//               <div
//                 className={`relative w-48 h-48 rounded-full overflow-hidden transform transition-all duration-300 ${
...
//                 }`}
//               >
//                 {/* For larger screens, the name will always appear */}
//                 {!isMobile && (
//                   <div className="bg-white bg-opacity-90 mx-4 py-1 px-3 rounded-full">
//                     <p className="text-sm font-semibold text-gray-900">{member.name}</p>
//                   </div>
...
//               {/* Member Display */}
//               <div
//                 className={`relative ${isMobile ? 'w-40 h-40' : 'w-48 h-48'} rounded-full overflow-hidden transform transition-all duration-300 ${
//                   hoveredMember === index || longPressedMember === index ? 'scale-110' : 'scale-100'
//                 }`}
//               >
//                 {/* Colored Background */}
