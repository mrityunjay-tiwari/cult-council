...
import { Music, PartyPopper,Drama } from 'lucide-react';

const FloatingMasqIcons = ({ 
  IconComponent = Drama, 
  iconCount = 25, 
  minSize = 10, 
  maxSize = 20, 
  ...
  const floatingIcons = [...Array(iconCount)].map((_, i) => ({
    ...
    duration: Math.random() *15 + 2, // Longer, varied duration
...
export default FloatingMasqIcons;