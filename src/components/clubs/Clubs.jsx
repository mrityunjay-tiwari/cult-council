...
/>
              ...
              {isInteractive && hoveredIndex === index && (
                ...
                <div className="absolute bottom-4 left-4 text-white text-lg font-semibold md:text-base">
                  <h1 className='font-bold text-5xl md:text-3xl' to='/imc'>{clubNames[index].label}</h1>
                  <h1>{clubNames[index].fullForm}</h1>
                </div>
