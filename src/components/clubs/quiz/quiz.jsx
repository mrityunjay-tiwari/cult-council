...
import QuizMedalShowcase from './awardsQuiz';
import FloatingMusicIcons from './bgQuiz';
import QuizCarousel from './eventsQuiz';
import QuizHelm from './quizHelm';
...
export function Quiz() {
  ...
  >
    ...
    <h2 className="mb-4 text-slate-400 text-3xl md:text-6xl font-medium">
      "Challenge Your Mind, Conquer Knowledge!"
    </h2>

    <p className="text-slate-100 font-light text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
    Welcome to the place to discuss whatever you love, from Messi to Michelangelo, from Gandhi to Garfield and everything else under the sun. Anything that you are passionate about you can share with like-minded people and participate in fun and interactive quizzes.
    </p>
  </motion.div>
</LampContainer>
