    ...
    <div className="bg-gradient-to-t from-slate-900 via-slate-950 to-gray-800 flex items-center justify-center pb-20 pt-10 h-1/4 relative z-100">
      <div className="relative">
        <div className="text-center mb-8">
          <h2 className="bg-gradient-to-br from-slate-300 to-slate-500 pt-8 pb-4 bg-clip-text text-center text-4xl font-semibold tracking-tight text-transparent md:text-5xl">Our Aavran</h2>
